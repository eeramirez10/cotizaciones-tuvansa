   ...
   Plugin.prototype =
           {
              ...
              initTemplate: function ()
              {
                  ...
                  var yearHtml =
                      ...
                      '<div><a href="#" class="btn btn-default dtp-select-year-range before" style="margin: 0;"><i class="ti-angle-up"></i></a></div>' +
                      yearPicker +
                      '<div><a href="#" class="btn btn-default dtp-select-year-range after" style="margin: 0;"><i class="ti-angle-down"></i></a></div>' +
                      '</div>';
                 ...
                 this.template = '<div class="dtp hidden" id="' + this.name + '">' +
                         ...
                         '<div class="dtp-close"><a href="#"><i class="ti-close"></i></a></div>' +
                         '</header>' +
                         '<div class="dtp-date hidden">' +
                         '<div>' +
                         '<div class="left center p10">' +
                         '<a href="#" class="dtp-select-month-before"><i class="ti-angle-left"></i></a>' +
                         '</div>' +
                         '<div class="dtp-actual-month p80">MAR</div>' +
                         '<div class="right center p10">' +
                         '<a href="#" class="dtp-select-month-after"><i class="ti-angle-right"></i></a>' +
                         '</div>' +
                         ...
                         '<div>' +
                         '<div class="left center p10">' +
                         '<a href="#" class="dtp-select-year-before"><i class="ti-angle-left"></i></a>' +
                         '</div>' +
                         '<div class="dtp-actual-year p80'+(this.params.year?"":" disabled")+'">2014</div>' +
                         '<div class="right center p10">' +
                         '<a href="#" class="dtp-select-year-after"><i class="ti-angle-right"></i></a>' +
                         '</div>' +
                         '<div class="clearfix"></div>' +
                         '</div>' +
                         '</div>' +
